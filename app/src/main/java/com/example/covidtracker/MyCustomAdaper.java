...
public class MyCustomAdaper extends ArrayAdapter<CountryModel> {

    private Context context;
    private List<CountryModel> countryModelList;
    private List<CountryModel> countryModelListFiltered;
    public MyCustomAdaper(Context context, List<CountryModel> countryModelList) {
    ...
    public View getView(int position,View convertView,ViewGroup parent) {
        ...
        ImageView imageView=view.findViewById(R.id.countryFlags);
